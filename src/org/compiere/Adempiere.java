...
//	static private final String	s_file100x30HR	= "images/AD10030HR.png";
	...
	public static Image getImage16()
	{
		if (s_image16 == null)
		{
			...
			URL url = ResourceFinder.getResource(s_File16x16);
	...
	public static Image getImageLogoSmall(boolean hr)
	{
		if (s_image48x15 == null)
		{
			...
			URL url = null;
			if (hr)
				url = ResourceFinder.getResource(s_file48x15HR);
			else
				url = ResourceFinder.getResource(s_file48x15);
		//	System.out.println(url);
			if (url == null)
				return null;
	...
	public static Image getImageLogo()
	{
		...
		{
			Toolkit tk = Toolkit.getDefaultToolkit();
			//URL url = ResourceFinder.getResource(s_file100x30);
			URL url = ResourceFinder.getResource(s_file100x30);
		//	System.out.println(url);
			if (url == null)
				return null;
	...
	public static ImageIcon getImageIcon32()
	{
		...
		{
			URL url = ResourceFinder.getResource(s_file32x32);
		//	System.out.println(url);
			if (url == null)
				return null;
