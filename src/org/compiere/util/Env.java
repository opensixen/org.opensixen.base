...
public final class Env
{
	...
	public static Image getImage (String fileNameInImageDir)
	{
		...
		URL url = ResourceFinder.getResource("images/" + fileNameInImageDir);
		if (url == null)
		{
	...
	public static ImageIcon getImageIcon2 (String fileName)
	{
		...
		URL url = ResourceFinder.getResource("images/" + fileName+".gif");
		if (url == null)
			//url = Adempiere.class.getResource("images/" + fileName+".png");
			url = ResourceFinder.getResource("images/" + fileName+".png");
		if (url == null)
		{
